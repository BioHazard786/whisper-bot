...
async def handle_start(message: Message) -> None:
    ...
    text = (
        ...
        "• <b>Reply Whispers:</b> Reply to someone with <code>/whisper secret</code> (no username needed!), or add more targets: <code>/whisper @extra 12345678 secret</code>\n"
...
async def handle_help(message: Message) -> None:
    ...
    text = (
        ...
        "**2. Reply Whispers (Direct & Multi-Target):**\n"
        "Reply to any message in the group:\n"
        "• `/whisper your secret message` — delivers directly to the replied user (no username/ID needed!)\n"
        "• `/whisper @user2 12345678 your secret message` — delivers to the replied user AND additional users!\n\n"
        "**3. Inline Whispers (Any Chat):**\n"
        ...
        "**4. One-Time Self-Destructing Whispers:**\n"
        "Add `!1` to permanently self-destruct as soon as read:\n"
        "`/whisper !1 secret message` (on reply)\n"
        "`@psst_whisper_bot !1 @recipient secret message`\n\n"
        "**5. User IDs & Multiple Targets:**\n"
...
async def handle_help_callback(callback: CallbackQuery) -> None:
    ...
    text = (
        ...
        "**2. Reply Whispers:**\n"
        "Reply to someone with `/whisper secret text` (no username needed!), or add more targets: `/whisper @user2 secret text`.\n\n"
        "**3. Inline Whispers (Any Chat):**\n"
